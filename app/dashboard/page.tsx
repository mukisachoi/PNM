...
export default function DashboardPage() {
  ...
  const [chartData, setChartData] = useState({
    ...
    data: [180, 190, 195, 210, 220, 235, 240, 248]
  });
  ...
  const recentActivities = [
    { title: '김철수님과 미팅', time: '2시간 전', color: 'bg-green-500', icon: Calendar },
    { title: '이영희님 연락처 추가', time: '5시간 전', color: 'bg-blue-500', icon: UserPlus },
    { title: '박민수님 생일 알림', time: '1일 전', color: 'bg-purple-500', icon: Bell },
  ];
